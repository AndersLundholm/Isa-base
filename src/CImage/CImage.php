...
class CImage {
    ...
    /**
     * Constructor runs displayImage() to process and display image.
     */
    ...
    /**
     * Display the image with all processing applied.
     */
    private function displayImage(){   
        $this->getAndValidateArgs();
        if($this->verbose) {
            $this->displayLog();
        }
        $this->getImageInfo();
    ...
    /**
     * Get the incoming arguments and validatethem.
     */
    private function getAndValidateArgs() {
    ...
    /**
     * Displaying log if verbose mode & create url to current image
     */
...
EOD;
     ...
     */
    private function calcWidthAndHeight() {
